...
def execute_tool(tool_call: dict) -> str:
    ...
    console.print(f"[yellow]Ejecutando herramienta: {tool_name} con parámetros {parameters}[/yellow]")
...
def main():
    ...
    console.print("[italic]Revisa el archivo README.md para más instrucciones.[/italic]")
